...
-- Production.Product, используя SELF JOIN.
SELECT DISTINCT Product1.StanderdCost, Product1.ProductSubcategoryID
FROM Production.Product AS Product1
INNER JOIN Production.Product AS Product2
ON Product1.StanderdCost = Product2.StanderdCost
WHERE Product1.ProductSubcategoryID <> Product2.ProductSubcategoryID
ORDER BY StanderdCost;
...
-- Sales.SalesPerson, но не содержатся в таблице Sales.Store.
